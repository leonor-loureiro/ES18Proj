...
public class RentingTest {
	...
	public void constructorFailDrivingLicenseNull() {
		RentACar rentACar = new RentACar("Eartz");
		Vehicle car = new Car(PLATE_CAR, 10, rentACar);
	...
	@Test(expected = CarException.class)
	public void constructorFailDrivingLicenseEmpty() {
		RentACar rentACar = new RentACar("Eartz");
		Vehicle car = new Car(PLATE_CAR, 10, rentACar);
	...
	@Test(expected = CarException.class)
	public void constructorFailBegin() {
		RentACar rentACar = new RentACar("Eartz");
		Vehicle car = new Car(PLATE_CAR, 10, rentACar);
		new Renting(DRIVING_LICENSE, null, date2, car);
	}
	@Test(expected = CarException.class)
	public void constructorFailEnd() {
		RentACar rentACar = new RentACar("Eartz");
		Vehicle car = new Car(PLATE_CAR, 10, rentACar);
		new Renting(DRIVING_LICENSE, date1, null, car);
	}
	@Test(expected = CarException.class)
	public void constructorFailCar() {
