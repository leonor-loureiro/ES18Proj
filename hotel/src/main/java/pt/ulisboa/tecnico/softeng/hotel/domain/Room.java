...
public class Room {
	...
	public Booking reserve(Type type, LocalDate arrival, LocalDate departure, String buyerNIF) {
		...
		Booking booking = new Booking(this.hotel, type, arrival, departure, buyerNIF);
