...
public class BookingController {
	...
	public String bookingSubmit(Model model, @PathVariable String code, @PathVariable String number,
		...
		logger.info("bookingSubmit hotelCode:{}, roomNumber:{}, arrival:{}, departure:{}, buyerNif:{}, buyerIban:{}", code, number,
				booking.getArrival(), booking.getDeparture(), booking.getBuyerNif(), booking.getBuyerIban());
