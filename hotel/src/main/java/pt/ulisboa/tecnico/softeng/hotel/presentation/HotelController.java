...
public class HotelController {
	...
	public String hotelSubmit(Model model, @ModelAttribute HotelData hotelData) {
		logger.info("hotelSubmit name:{}, code:{}, nif{}, iban{}, priceSingle{}, priceDouble{}", hotelData.getName(), hotelData.getCode(), hotelData.getNif(), hotelData.getIban(), hotelData.getPriceSingle(), hotelData.getPriceDouble());
