...
public class InvoiceProcessorProcessInvoiceMethodTest {
	...
	@Test
	public void oneTaxFailureTwoInQueue(@Mocked final TaxInterface taxInterface,
	...
	@Test
	public void oneRemoteFailureTwoInQueue(@Mocked final TaxInterface taxInterface,
			@Mocked final BankInterface bankInterface) {
		new Expectations() {
			{
				BankInterface.processPayment(this.anyString, this.anyDouble);
